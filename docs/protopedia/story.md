...
AI が回答・採点結果と教材を照合して欠落を特定し、「例外」への追記パッチを提案しました。
人間が差分を確認して適用した後、次の教材バージョンの回答結果を再観測します。

この再現用デモデータでは、教材バージョンごとの平均スコアが
**1.8 → 2.9 → 3.6（4点満点）** と推移しました。

![教材バージョンごとの平均スコアを再観測し、1.8から3.6への推移を確認](../screenshots/13-course-editor-score-progression.png)
